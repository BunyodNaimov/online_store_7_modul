    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.CharField(blank=True, max_length=129, null=True)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_picture/')),
                ('address', models.CharField(blank=True, max_length=256, null=True)),
                ('birth_date', models.DateField(blank=True, null=True)),
                ('age', models.IntegerField(blank=True, null=True)),
                ('type', models.CharField(choices=[('salesman', 'Salesman'), ('buyer', 'Buyer'), ('admin', 'Admin')], default='buyer', max_length=50)),
